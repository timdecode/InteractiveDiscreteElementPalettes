...
public:
    ...
    enum class ClickMode { AddSingularity, AddSeed, Stretch, SketchExemplar, SketchVoid };
...
private:
	...
	void _voidClick( FEditorViewportClient* InViewportClient, FViewport* InViewport, UStaticMeshComponent* staticMesh, URegionGrowingComponent* regionGrower );
	bool _voidUpdate( FEditorViewportClient* InViewportClient, FViewport* InViewport );
	bool _voidEnd( FEditorViewportClient* InViewportClient, FViewport* InViewport );
