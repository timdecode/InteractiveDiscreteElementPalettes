...
class REGIONGROWING_API Utility
{
public:
...
inline FVector unreal(const tcods::Vector v)
{
...
inline Eigen::Vector3f eigen(const tcods::Vector v)
{
    return Eigen::Vector3f(v.x, v.y, v.z);
}

inline tcods::Vector to_tcods(FVector v)
{
    return tcods::Vector(v.X, v.Y, v.Z);
}

inline tcods::Vector to_tcods( Eigen::Vector3f v )
{
    return tcods::Vector( v.x(), v.y(), v.z() );
}
...
//    tcods::Vector tcods;
//    
//    rgVector3f() { new(&eigen) Eigen::Vector3f(0.0f, 0.0f, 0.0f); }
//    rgVector3f(const rgVector3f& other) { new(&eigen) Eigen::Vector3f(other); }
//};
